...
public partial class FireballInteraction : Node {
    ...
    private Node? _interactionWithFireballNode;
    ...
    public override void _PhysicsProcess(double delta) {
        ...
        foreach (var result in results) {
            ...
            if (result.HasMeta("InteractionWithFireball")) {
                _interactionWithFireballNode = (Node)result.GetMeta("InteractionWithFireball");
            }
            if (_interactionWithFireballNode is IFireballHittable fireballHittable) {
