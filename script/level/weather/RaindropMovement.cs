...
public partial class RaindropMovement : Node {
    ...
    private RaindropStateEnum _state = RaindropStateEnum.Falling;
    ...
    public void Reset() {
        if (_parent == null || _rainyController == null || _windyController == null
            || _sprite == null || _animation == null) return;

        _sprite.Visible = true;
        _animation.Visible = false;
        _state = RaindropStateEnum.Falling;
    ...
    public override void _PhysicsProcess(double delta) {
        ...
        if (_state == RaindropStateEnum.Splash) {
    ...
    public void SetFadeOut() {
        _state = RaindropStateEnum.Splash;
        _sprite?.SetVisible(false);
    }
}